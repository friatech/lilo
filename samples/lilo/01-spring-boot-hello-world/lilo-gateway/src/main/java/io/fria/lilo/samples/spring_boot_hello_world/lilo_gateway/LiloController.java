 ...
 */
package io.fria.lilo.samples.spring_boot_hello_world.lilo_gateway;
...
public class LiloController {
  ...
  public LiloController() {
    ...
    this.lilo =
        Lilo.builder()
            .addSource(RemoteSchemaSource.create(SOURCE1_NAME, SOURCE1_GRAPHQL_URL))
            .addSource(RemoteSchemaSource.create(SOURCE2_NAME, SOURCE2_GRAPHQL_URL))
            .build();
  }
